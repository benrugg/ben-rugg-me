  ...
  fragmentShader: `
    ...
    void main() {
      ...
      if(hoverLevel > 0.) {
        ...
        color = texture2D(textureImage, uv);
        // RGBshift
        color.r = texture2D(textureImage, uv+(hoverLevel)*0.01).r;
        color.g = texture2D(textureImage, uv-(hoverLevel)*0.01).g;
      }
