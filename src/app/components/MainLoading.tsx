...
export default function MainLoading(props: { doAnimateIn: boolean }) {
  return (
    <div
      className={`h-[100dvh] w-screen absolute flex flex-col justify-center items-center bg-black text-white ${firaCode.className} text-sm uppercase`}
    >
      <div className={`flex flex-col items-center justify-center ${props.doAnimateIn ? "fade-and-slide-in" : ""}`}>
